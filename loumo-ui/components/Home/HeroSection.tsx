    ...
    return (
        <div className='flex flex-col gap-7 px-7 md:pt-7 w-full items-center'>
            <div className='relative bg-gradient-to-b from-[#4CA697] to-[#BEE3A7] flex flex-row items-center sm:rounded-[20px] px-[60px] pt-10 pb-30 gap-12 max-w-[1344px] w-screen sm:w-full '>
                ...
                <div className='flex flex-col items-center gap-5 h-[100px] z-20'>
                ...
                <img src="/Images/hero.png" alt="Hero" className='absolute max-w-[320px] mx-auto sm:max-w-[200px] md:max-w-[250px] lg:max-w-[450px] xl:max-w-[530px] w-full h-auto top-0 sm:top-[50%] md:top-[40%] lg:top-5 xl:top-0 right-[20px] z-0 sm:right-[10px] md:right-[5px] xl:right-[79px]' />
            </div>
        </div>
    )
}
